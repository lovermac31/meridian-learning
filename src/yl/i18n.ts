...
const en: Dict = {
  ...
  'hero.h1': 'Speaking <span class="orange">Confidence</span> for Ages 9-18',
  'hero.subtitle':
    'IELTS-aligned coaching that helps young learners speak more clearly, think more confidently, and communicate with purpose.',
  'hero.motto': 'Excavate <span>·</span> Analyze <span>·</span> Justify <span>·</span> Reflect',
  'hero.ctaBook': 'Book a free 30-minute evaluation',
  ...
  'parents.p':
    'Speaking is the hardest skill to build — and the one that opens the most doors. So we start early and make progress you can hear.',
  'parents.whoFor':
  ...
  'pricing.card3h': 'Small-group speaking practice',
  'pricing.card3p': 'Peers, motivation, and a lower cost. Max 6, six weeks.',
  'pricing.privateH3': '1-to-1 coaching: personal pace and targeted feedback',
  ...
  'book.bookingH2': 'Book a free 30-minute evaluation',
  'book.bookingP': "Book your child's free 30-minute speaking evaluation. You'll get their current level and one clear next step — no obligation, no pressure.",
