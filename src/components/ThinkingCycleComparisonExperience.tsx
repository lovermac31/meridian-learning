...
const getAssessmentType = (assessmentLine: string) =>
  assessmentLine.replace(/^Assessment type:\s*/, '').replace(/\.$/, '');
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 py-20">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-white leading-tight">
              Compare all four Thinking Cycle stages
            </h1>
            <p className="mt-6 text-lg text-white/72 leading-relaxed max-w-3xl">
              ...
              who need a fast comparison of the lesson architecture across Analyze, Evaluate, Justify,
              and Reflect.
            </p>
          </motion.div>
        </div>
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="rounded-2xl bg-jurassic-soft/25 p-5">
                      <p className="text-xs uppercase tracking-widest text-gray-400 font-bold mb-2">Cognitive Operation</p>
                      <p className="text-jurassic-dark font-semibold leading-relaxed">{stage.cognitiveOperation}</p>
                    </div>
                    <div className="rounded-2xl bg-jurassic-soft/25 p-5">
                      <p className="text-xs uppercase tracking-widest text-gray-400 font-bold mb-2">Bloom Level</p>
                      <p className="text-jurassic-dark font-semibold leading-relaxed">{stage.bloomLevel}</p>
                    </div>
                    <div className="rounded-2xl bg-jurassic-soft/25 p-5">
                      <p className="text-xs uppercase tracking-widest text-gray-400 font-bold mb-2">Primary Target</p>
                      <p className="text-jurassic-dark font-semibold leading-relaxed">{stage.primaryTarget}</p>
                    </div>
                    <div className="rounded-2xl bg-jurassic-soft/25 p-5">
                      <p className="text-xs uppercase tracking-widest text-gray-400 font-bold mb-2">Lesson Slot</p>
                  ...
                  <div className="grid gap-4">
                    <div className="rounded-2xl border border-jurassic-soft/70 p-5">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <p className="text-xs uppercase tracking-widest text-gray-400 font-bold">Primary Activity</p>
                      </div>
                    ...
                    <div className="rounded-2xl border border-jurassic-soft/70 p-5">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <p className="text-xs uppercase tracking-widest text-gray-400 font-bold">Assessment Type</p>
                      </div>
                    ...
                    <div className="rounded-2xl border border-jurassic-soft/70 p-5">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <p className="text-xs uppercase tracking-widest text-gray-400 font-bold">Cross-Stage Role</p>
                      </div>
